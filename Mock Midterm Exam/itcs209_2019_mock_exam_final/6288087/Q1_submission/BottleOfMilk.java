...
public class BottleOfMilk extends Item {
	...
	public String toString() {
		return "[Milk" + ": Value = " + String.format("%.2f", this.getCurrentValue()) + " Baht, Milk left = "
				+ getVolume() + " ml]";
	}
	...
	public BottleOfMilk clone() {
		// Your Code Goes Here
		BottleOfMilk cloneMilk = new BottleOfMilk(this.getPurchasePrice(), this.getAge(), this.getWeight(), this.getVolume());
		return cloneMilk;
	}
}
