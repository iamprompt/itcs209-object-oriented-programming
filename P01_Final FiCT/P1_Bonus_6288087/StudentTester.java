...
public class StudentTester {
	...
	public static void bonusCredit()
	{
		...
		//Add players to the front row of Team A
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Samurai, Arena.Row.Front, 1);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Phoenix, Arena.Row.Front, 2);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Tank, Arena.Row.Front, 3);
		...
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Healer, Arena.Row.Back, 4);
		battleField.addPlayer(Arena.Team.A, Player.PlayerType.Phoenix, Arena.Row.Back, 5);
		//////////////////////////////////////////////////////////////////////////////////
