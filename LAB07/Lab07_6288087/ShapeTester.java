...
public class ShapeTester {
	   public static void main(String[] args) {
	      ...
	      System.out.println(s5);  // Run Triangle's toString()
		   ...
		   Circle c1 = new Circle();  // Upcast
		   c1.setColor("red");
		   System.out.println("-- Circle 1 --");
		   System.out.println("Area is " + c1.getArea(7.0));  // Run Circle's getArea()
		   System.out.println(c1);  // Run Triangle's toString()

		   Circle c2 = new Circle("yellow",10);  // Upcast
		   System.out.println("-- Circle 2 --");
		   System.out.println("Area is " + c2.getArea());  // Run Circle's getArea()
		   System.out.println(c2);  // Run Triangle's toString()
	   }
	}
